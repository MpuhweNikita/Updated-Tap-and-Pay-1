...
- Frontend: http://localhost:9202
- Backend: http://localhost:8202
...
- `rfid/niki_team/card/status`: ESP8266 publishes card UID and balance when detected
- `rfid/niki_team/card/topup`: Backend publishes top-up commands
- `rfid/niki_team/card/balance`: ESP8266 publishes confirmation of balance update
- `rfid/niki_team/card/payment`: Backend publishes payment confirmations
- `rfid/niki_team/card/removed`: ESP8266 publishes when card is removed
- `rfid/niki_team/device/status`: MQTT Last Will (online/offline)
- `rfid/niki_team/device/health`: Periodic health metrics (IP, RSSI, Memory)
...
- **Local**: Uses `localhost:8202`
- **Production**: Uses `157.173.101.159:8202`
...
- Verify port 8202 is available: `lsof -i :8202`
...
- Test backend: `curl http://localhost:8202/cards`
...
- Firewall configured for ports 9202, 8202, 1883
